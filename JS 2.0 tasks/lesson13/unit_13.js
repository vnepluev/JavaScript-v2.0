...
function f11() {
    i11 = document.querySelector('.i-11').value;
    delete a11[i11];
    f5(a11, '.out-11');
}
...
function f20() {
    ...
    document.querySelector('.out-20').textContent = out20;
}
