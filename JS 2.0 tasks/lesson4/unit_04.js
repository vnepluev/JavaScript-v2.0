...
function f4() {
    let i4 = document.querySelector('.i-4').checked;
...
function f5() {
    ...
    i5.checked ? out5.textContent = i5.value : out5.textContent = false;
}
...
function f6() {
    ...
    out6.textContent = document.querySelector('.i-6').value;
}
...
function f7() {
    ...
    i7.length < 1 ? out72.textContent = 0 : out72.textContent = 1;
}
...
function f8() {
    ...
    out8.innerHTML = '<input type="text" class="i-81" value="inpValue"><button class="b-81">b81</button>';
    document.querySelector('.b-81').onclick = f81;
}

function f81 () {
    const out81 = document.querySelector('.out-81');
    out81.textContent = document.querySelector('.i-81').value;
}
...
function f9() {
    ...
    r9.checked ? out9.textContent = r9.value : out9.textContent = 0;
}
...
function f13() {
    ...
    document.querySelector('.out-13').textContent = i13.value;
}
...
function f20(e) {
    ...
    out20.textContent = `${form.elements.username.value} ${form.elements[1].value}`;
}
