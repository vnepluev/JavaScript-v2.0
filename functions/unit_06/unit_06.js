...
// Task 8
// Метод Math.max - позволяет находить максимум из любого количества переданных в него аргументов. Например, он сработает и так Math.max(22,33,1,2,33,44,55,1,100,45) и так Math.max(33,1,2) (проверьте самостоятельно). Минус метода - его тяжело использовать если мы не знаем количество передаваемых в него аргументов. Давайте напишем следующий код (см. код). Как видите, теперь не важно сколько элементов в массиве, и мы всегда сможем найти максимум. Обратите внимание, в качестве контекста мы передали null. 
